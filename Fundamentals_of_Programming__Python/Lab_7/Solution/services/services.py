...
from Fundamentals_of_Programming__Python.Lab_7.Solution.repository.memory_repository import MemoryRepository
from Fundamentals_of_Programming__Python.Lab_7.Solution.repository.text_file_repository import TextFileRepository
from Fundamentals_of_Programming__Python.Lab_7.Solution.repository.binary_file_repository import BinaryFileRepository
from Fundamentals_of_Programming__Python.Lab_7.Solution.repository.json_repository import JsonRepository
from Fundamentals_of_Programming__Python.Lab_7.Solution.repository.database_repository import DatabaseRepository
...
class Services:
    def __init__(self):
        ...
        config.read("../repository/settings.properties")
        ...
        if self.__repository == "memory_repository":
            ...
            f = open("../repository/expenses.txt")
            if f.read() == "":
                self.__generate_expenses()
            f.close()
            ...
            f = open("../repository/expenses.dat", "rb")
            if f.read() == b"":
                self.__generate_expenses()
            f.close()
