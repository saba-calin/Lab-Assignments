...
from src.domain.validation_exceptions import ClientValidationException
from src.domain.validation_exceptions import MovieValidationException
from src.domain.validation_exceptions import RentalValidationException
